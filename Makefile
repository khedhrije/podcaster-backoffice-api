...
.PHONY: docker
docker:
	docker buildx build -t khedhrije/podcaster-backoffice-api:latest --build-arg COMMIT_HASH=$(LAST_COMMIT) . && docker push khedhrije/podcaster-backoffice-api:latest
